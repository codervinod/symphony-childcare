...
export default function ParentResourcesPage() {
  const faqs = [
    ...
    },
    {
      ...
      answer: "We provide pickup and drop-off services for Warm Springs Elementary, James Leitch Elementary, and Weibel Elementary schools. We're conveniently located at 681 Navajo Way in Fremont."
    },
    {
    ...
    },
    {
      ...
      answer: "We provide a dedicated quiet time for homework completion with caring staff available to offer assistance and support when needed."
    },
    {
                ...
                <div className="card">
                  ...
                  <ol className="space-y-3 text-gray-700">
                    ...
                    <li className="flex items-start space-x-3">
                      ...
                      <span>Visit our facility and meet our caring staff</span>
                    </li>
                    <li className="flex items-start space-x-3">
              ...
              <div className="card-warm">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li className="flex items-center space-x-2">
                    ...
                    <span>Constant supervision by caring staff</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <svg className="w-4 h-4 text-accent-600" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
